  ...
  var Mapplic = function (element) {
    ...
    function Tooltip() {
      ...
      this.show = function (location) {
        if (location) {
          ...
          this.el.stop().show();
          this.zoom(location);
          _changeBoothViewMapFunc(location.title)
        }
      }
    ...
    function HoverTooltip() {
      ...
      this.show = function (location) {
        if (self.tooltip.location != location) {
          this.title.text(location.exhibitorName);
    ...
    var processData = function (data) {
        ...
        $.each(data.levels, function (index, level) {
          ...
          switch (extension) {
            ...
            case 'gif':
              ...
              // Vector format
            case 'svg':
              $('<div></div>').addClass('mapplic-map-image').load(escape(source), function () {
      ...
      if (nrlevels > 1) {
        ...
        var switchBasic = $("#switch-id_basic")
        var switchPro = $("#switch-id_pro")
        var switchPre = $("#switch-id_premium")
        var goBasic = $('#goto-basic')
        var goPro = $('#goto-pro')
        var goPremium = $('#goto-premium')
        var togglePro = $('.toggle-btn_pro')
        var togglePre = $('.toggle-btn_premium')
        var toggleBasic = $('.toggle-btn_basic')
        var navCenter = $('.map_menu_center')
        var navRight = $('.map_menu_right')
        var navLeft = $('.map_menu_left')
        var navTab = $('.navbar_map_tab')

        window.viewMapBySubscription = function (subscriptionType) {
          //If Subscription is Basic
          if (subscriptionType == "Basic") {
            self.switchLevel('basic');
          }

          //If Subscription is Premium
          if (subscriptionType == "Premium") {
            navTab.css('background','none')
            goPro.css("display", "none")
            goBasic.css("display", "none")
            togglePro.css('display', 'none')
            toggleBasic.css('display', 'none')
            togglePre.css('display', 'block')
            self.switchLevel('premium');
          }

          //If Subscription is Pro
          if (subscriptionType == "Pro") {
            navCenter.css('display', 'none')
            navRight.css('margin','0 auto')
            navLeft.css('display', 'none')
            navTab.css('background','none')
            togglePro.css('display', 'block')
            toggleBasic.css('display', 'none')
            togglePre.css('display', 'none')
            self.switchLevel('pro');

          }

          //Switch Map to Basic
          switchBasic.change(function () {
            if ($(this).is(":checked")) {
              self.switchLevel('basic-3d');
              $(document).on('click', '#goto-basic', function (e) {
                self.switchLevel('basic-3d');
                e.preventDefault();
              });
            } else {
         ...
         //Switch Map to Premium
          switchPre.change(function () {
            if ($(this).is(":checked")) {
              self.switchLevel('pre3d');
              $(document).on('click', '#goto-premium', function (e) {
                self.switchLevel('pre3d');
                e.preventDefault();
              });
            } else {
          ...
          //Switch Map to Pro
          switchPro.change(function () {
            if ($(this).is(":checked")) {
              self.switchLevel('pro-3d');
              $(document).on('click', '#goto-pro', function (e) {
                self.switchLevel('pro-3d');
                e.preventDefault();
              });
            } else {
          ...
          //Show Map Basic When CLick Nav Tab Basic
          $(document).on('click', '#goto-basic', function (e) {
            self.switchLevel('basic');
            e.preventDefault();
            goBasic.css('background', '#4e6ef2')
            goPro.css('background', 'transparent')
            goPremium.css('background', 'transparent')
            togglePro.css('display', 'none')
            togglePre.css('display', 'none')
            toggleBasic.css('display', 'block')
          });

          //Show Map Premium When CLick Nav Tab Premium
          $(document).on('click', '#goto-premium', function (e) {
            self.switchLevel('premium');
            e.preventDefault();
            goPremium.css('background', '#4e6ef2')
            goPro.css('background', 'transparent')
            goBasic.css('background', 'transparent')
            togglePro.css('display', 'none')
            toggleBasic.css('display', 'none')
            togglePre.css('display', 'block')
          });

          //Show Map Pro When CLick Nav Tab Pro
          $(document).on('click', '#goto-pro', function (e) {
            self.switchLevel('pro');
            e.preventDefault();
            goPro.css('background', '#4e6ef2')
            goBasic.css('background', 'transparent')
            goPremium.css('background', 'transparent')
            togglePro.css('display', 'block')
            toggleBasic.css('display', 'none')
        ...
        //Call viewMapBySubscription
        window.parent.viewMapBySubscription(subscriptionType)
      }
